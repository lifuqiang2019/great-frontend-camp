        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 py-[10px] flex items-center justify-center gap-2 bg-[#24292e] hover:bg-[#1a1e22] text-white font-bold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="flex-1 py-[10px] flex items-center justify-center gap-2 bg-[#07C160] hover:bg-[#06ad56] text-white font-bold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
